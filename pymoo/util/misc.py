...
def normalize_by_asf_interceptions(x, first_front, prev_S=None, prev_asf=None, return_bounds=False):
    ...
    :param x: Original objective population
    :param first_front: length of the first front, represents the first f indexes of x
    :param prev_S: Stored extreme points
    :param prev_asf: Stored asf values
    :param return_bounds: Flag to return bounds, if true, F_max an F_min of population are returned
    :return: Normalized population N, asf and S matrices to store, optionally F_min, F_max
    """
