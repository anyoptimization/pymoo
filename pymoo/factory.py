...
@deprecation.deprecated(deprecated_in="0.6.0", removed_in="0.7.0",
                        ...
                        details="Moved to `from pymoo.termination import get_termination`")
...
@deprecation.deprecated(deprecated_in="0.6.0", removed_in="0.7.0",
                        current_version=__version__,
                        details="Moved to `from pymoo.util.ref_dirs import get_reference_directions`")
...
@deprecation.deprecated(deprecated_in="0.6.0", removed_in="0.7.0",
                        current_version=__version__,
                        details="Moved to `from pymoo.problem import get_problem`")
...
def get_algorithm(*args, **kwargs):
    raise Exception("The method `get_algorithm` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface.")


def get_sampling(*args, **kwargs):
    raise Exception("The method `get_sampling` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/operators/selection.html")


def get_selection(*args, **kwargs):
    raise Exception("The method `get_selection` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/operators/selection.html")


def get_crossover(*args, **kwargs):
    raise Exception("The method `get_crossover` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/operators/crossover.html")


def get_mutation(*args, **kwargs):
    raise Exception("The method `get_mutation` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/operators/mutation.html")


def get_visualization(*args, **kwargs):
    raise Exception("The method `get_visualization` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/visualization/index.html")


def get_performance_indicator(*args, **kwargs):
    raise Exception("The method `get_performance_indicator` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface:\n"
                    "https://pymoo.org/misc/indicators.html")


def get_decision_making(*args, **kwargs):
    raise Exception("The method `get_decision_making` has been deprecated since 0.5.0\n"
                    "Please use the object-oriented interface.")
