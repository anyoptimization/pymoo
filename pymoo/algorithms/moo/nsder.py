...
class NSDER(NSDE):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        NSDE-R extends NSDE to many-objective problems using NSGA-III reference-direction survival.
        ...
        ----------
        ref_dirs : array-like
            Reference directions (shape: [n_dirs, n_obj]).
        pop_size : int, optional
            Population size. Defaults to len(ref_dirs).
        variant : str
            DE strategy string. Defaults to 'DE/rand/1/bin'.
        CR : float
            Crossover rate. Defaults to 0.7.
