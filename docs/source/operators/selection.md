...
.. meta::
   :description: This module defines the mating selection during the execution of a genetic algorithm

+++

.. meta::
   :keywords: Selection, genetic operator, evolutionary algorithm, multi-objective optimization, pymoo, Python
